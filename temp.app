...
const { getWeek } = require('date-fns'); // Importing getWeek from date-fns
...
const getDateKeys = () => {
  ...
  // Using date-fns to get the correct week number
  const week = getWeek(now); // getWeek is now working properly
